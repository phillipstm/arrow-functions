...
const multiLiner = (word, toUpperCase) => `${word.toUpperCase('')}`;
...
const oldObject = () => (`${oldObject[0, 1, 2]}`);
...
// This is pointing to the Student oject creator function.
//
// 2. What is "this" when joe.scopeArrow() is invoked?

//This is pointing to the browser window.

//
// 3. Explain why "this" is different when an arrow function is used.
//
// The keyword this is NOT bound to the element when using the arrow function. If we use a regular funtion the keyword this is bound to the element.